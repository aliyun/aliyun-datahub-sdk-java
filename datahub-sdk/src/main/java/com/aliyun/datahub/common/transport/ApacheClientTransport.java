...
public class ApacheClientTransport implements Transport {
    ...
    public ApacheClientTransport(DatahubConfiguration conf) {
        ...
        httpClient.setProxyHostName(conf.getProxyHostName());
        httpClient.setProxyPort(conf.getProxyPort());
        httpClient.setProxyUsername(conf.getProxyUsername());
        httpClient.setProxyPassword(conf.getProxyPassword());
