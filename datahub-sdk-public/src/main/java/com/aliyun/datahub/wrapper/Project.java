...
public class Project {
    ...
    public static class Builder {
        public static Project build(String projectName, com.aliyun.datahub.DatahubClient client) {
     ...
     */
    private Project(GetProjectResult data, com.aliyun.datahub.DatahubClient client) {
        this.data = data;
        this.client = client;
    }
