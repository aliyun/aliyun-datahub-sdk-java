...
public class Topic {
    ...
    public static class Builder {
        public static Topic build(String projectName, String topicName, com.aliyun.datahub.DatahubClient client) {
        ...
        public static Topic build(String projectName, String topicName, DatahubConfiguration conf) {
            com.aliyun.datahub.DatahubClient client = new com.aliyun.datahub.DatahubClient(conf);
            return build(projectName, topicName, client);
        }
    }

    private GetTopicResult data;
    private com.aliyun.datahub.DatahubClient client;
     ...
     */
    private Topic(GetTopicResult data, com.aliyun.datahub.DatahubClient client) {
        this.data = data;
        this.client = client;
    }
     ...
     * @param type
     * @return cursor
     * @see GetCursorRequest.CursorType
     */
