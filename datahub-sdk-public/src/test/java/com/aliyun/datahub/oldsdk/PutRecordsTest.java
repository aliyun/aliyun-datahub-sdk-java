...
public class PutRecordsTest {
    ...
    public void testPutRecordWithRetry() {
        ...
        RecordEntry containNullEntry = new RecordEntry(schema);
        containNullEntry.setShardId("0");
        containNullEntry.setBoolean("e", true);
        recordEntries.add(containNullEntry);
        ...
        Assert.assertEquals(2, recordsResult.getRecordCount());
    }
    ...
    public void testInvalidShard() {
        ...
        Assert.assertEquals(failedRecord.size(), result.getFailedRecords().size());
